...
def gerar_conteudo_estudo(tema):
    ...
    {{
        ...
        "explicacao_topicos": [
            {{"titulo": "Nome do Tópico", "conteudo": "Explicação clara, de maneira detalhada sem deixar de apontar os pontos mais importantes. Use exemplos do cotidiano, fatos atuais e comparações."}}
        ],
